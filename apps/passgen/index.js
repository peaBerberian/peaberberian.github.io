...
const copyButtonSvg = `<svg style="display: none; float: right" width="22px" height="22px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" >
	<path
