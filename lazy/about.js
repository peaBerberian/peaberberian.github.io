...
<div class="quickLinks"><b>External links: </b>${y(g,n)}</div></div>`},current:{title:"What I work on",description:`<span>
...
</span>`},experiences:{title:"Experiences",description:"<p>I have more than 13 years of professional software engineering experience.</p>"+v(u,n)},education:{title:"Education",description:`<p>I have a french engineering diploma (called <a href="https://en.wikipedia.org/wiki/Dipl%C3%B4me_d%27Ing%C3%A9nieur" target="_blank">"dipl\xF4me d'ing\xE9nieur"</a>) - a 5-year diploma delivered by french engineering schools, equivalent to a master's degree in engineering.</p><p>My cursus had a specialization in telecommunications and networks engineering.</p>`+b(h,n)}};return{sidebar:[{icon:"\u{1F44B}\u{1F3FB}",text:"General info",centered:!0,render:t("general")},{icon:"\u{1F4BC}",text:"What I do",centered:!0,render:t("current")},{icon:"\u{1F3E2}",text:"Experiences",section:"experiences",centered:!0,render:t("experiences")},{icon:"\u{1F3EB}",text:"Education",centered:!0,render:t("education")}]};function t(r){return d=>{let o=document.createElement("div"),m=e(s[r].title,{});o.appendChild(m);let c=document.createElement("div");if(c.innerHTML=`${s[r].description}`,o.appendChild(c),r==="general"){let p=document.createElement("p"),l=document.createElement("span");l.appendChild(i(d)),p.appendChild(l),o.appendChild(p)}return o}}}function v(a,n){return a.map(e=>`<div class="job-item item-group">
...
`).join("")}function b(a,n){return a.map(i=>`<div class="edu-item item-group">
  <div class="group-header">
    <span class= "item-group-img-container">
...
`}}function y(a,n){return a.map(e=>`<a class="quicklink-link" href="${e.link}" target="_blank"><img class="quicklink-img" title="${e.description}" alt="${e.description}" src="${n.getImageRootPath()+e.img}"/></a>`).join("")}export{w as create};
