var i="https://github.com/peaberberian/gif-renderer.rs";function a(n,e){let{strHtml:r,createAppTitle:t}=e.appUtils;return{sidebar:[{text:"Overview",icon:"\u{1F9D1}\u200D\u{1F3EB}",centered:!0,render:()=>r`<div>
	${t("gif-renderer.rs",{github:i})}
