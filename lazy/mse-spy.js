var e="https://github.com/peaberberian/MSESpy.js";function r(o,t){let{strHtml:a,createAppTitle:i}=t.appUtils;return{sidebar:[{text:"Overview",icon:"\u{1F9D1}\u200D\u{1F3EB}",centered:!0,render:()=>a`<div>
	${i("MSESpy",{github:e})}
<p><a href="${e}" target="_blank">MSESpy</a> is a reverse-engineering tool I developed to easily see when a webpage calls "MSE" web API</p>
