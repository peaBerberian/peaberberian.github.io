/** This is the code for the app identified as "other_projects_paul-envs". */
var i="https://github.com/peaberberian/paul-envs";function r(a,t){let{createAppTitle:o}=t.appUtils;return t.updateTitle(null,"Other Projects: paul-envs"),{sidebar:[{text:"Overview",icon:"\u{1F9D1}\u200D\u{1F3EB}",centered:!0,render:()=>{let e=document.createElement("div");e.appendChild(o("paul-envs",{github:i}));let n=document.createElement("div");return e.appendChild(n),n.innerHTML=`<p><i>paul-envs</i> is my own development container manager.</p>
...
<p>I use it heavily at work and on some personal projects where I can profit from the supplementary isolation.</p>`,e}}]}}export{r as create};
