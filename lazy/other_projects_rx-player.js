/** This is the code for the app identified as "other_projects_rx-player". */
var l="https://developers.canal-plus.com/rx-player/",s="https://developers.canal-plus.com/rx-player/doc/api/Overview.html",r="https://github.com/canalplus/rx-player";function d(i,a){let{createAppTitle:n,createExternalIframe:o}=a.appUtils;return a.updateTitle(null,"Other Projects: RxPlayer"),{sidebar:[{text:"Overview",icon:"\u{1F9D1}\u200D\u{1F3EB}",centered:!0,render:()=>{let e=document.createElement("div");e.appendChild(n("RxPlayer",{github:r,doc:s,demo:l}));let t=document.createElement("div");return e.appendChild(t),t.innerHTML=`<p>The <a href="${r}" target="_blank">RxPlayer</a> is an advanced media player adapted for large streaming companies: instead of just relying on a video element's \`src\` attribute and let the browser handle contents, the RxPlayer progressively loads chunks of audio and video data and then push them to lower-level buffers. It can also rely on other browser API to decrypt an encrypted content.</p>
...
<p>The RxPlayer thus fills the role of a library interacting with those standards to play a content efficiently in a web browser.</p>`,e}},{text:"Demo",icon:"\u{1F4FA}",noPadding:!0,render:()=>o("https://developers.canal-plus.com/rx-player/")}]}}export{d as create};
