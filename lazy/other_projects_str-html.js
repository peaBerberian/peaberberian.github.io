/** This is the code for the app identified as "other_projects_str-html". */
var r="https://github.com/peaberberian/str-html";function n(o,t){let{createAppTitle:i}=t.appUtils;return t.updateTitle(null,"Other Projects: str-html"),{sidebar:[{text:"Overview",icon:"\u{1F9D1}\u200D\u{1F3EB}",centered:!0,render:()=>{let e=document.createElement("div");e.appendChild(i("str-html",{github:r}));let a=document.createElement("div");return e.appendChild(a),a.innerHTML=`<p>str-html is a very fast and lightweight UI library allowing to write HTML-in-JS without needing to bring an heavy library or transpilation step (unlike most popular attempts at simplifying HTML-in-JS like JSX or svelte).</p>
  ...
  <div class="separator"></div>
    ...
    <p>Thanks to its simplicity, I now consider this project complete: I do not see how I could improve it without making its API needlessly more complex.</p>`,e}}]}}export{n as create};
