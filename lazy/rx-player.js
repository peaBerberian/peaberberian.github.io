var s="https://developers.canal-plus.com/rx-player/",o="https://developers.canal-plus.com/rx-player/doc/api/Overview.html",e="https://github.com/canalplus/rx-player";function d(l,a){let{strHtml:t,createAppTitle:r,createAppIframe:n}=a.appUtils;return{sidebar:[{text:"Overview",icon:"\u{1F9D1}\u200D\u{1F3EB}",centered:!0,render:()=>t`<div>
${r("RxPlayer",{github:e,doc:o,demo:s})}

<p>The <a href="${e}" target="_blank">RxPlayer</a> is an advanced media player adapted for large streaming companies: instead of just relying on a video element's \`src\` attribute and let the browser handle contents, the RxPlayer progressively loads chunks of audio and video data and then push them to lower-level buffers. It can also rely on other browser API to decrypt an encrypted content.</p>
...
</div>`},{text:"Demo",icon:"\u{1F4FA}",noPadding:!0,render:()=>n("https://developers.canal-plus.com/rx-player/")}]}}export{d as create};
