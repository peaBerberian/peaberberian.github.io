var h="https://github.com/peaberberian/peaberberian.github.io";function c(d,i){let{strHtml:e,createAppTitle:t}=i.appUtils;return{sidebar:[{text:"Overview",centered:!0,icon:"\u{1F9D1}\u200D\u{1F3EB}",render:o},{text:"Making it efficient",centered:!0,icon:"\u{1F3CE}\uFE0F",render:n},{text:"Making it configurable",centered:!0,icon:"\u{1F9F0}",render:a},{text:"Why so many emojis?",centered:!0,icon:"\u{1F635}\u200D\u{1F4AB}",render:s},{text:"Some Anecdotes",centered:!0,icon:"\u{1F388}",render:r},{text:"External Resources",centered:!0,icon:"\u{1FAF6}",render:l}]};function o(){return e`<div>
${t("About This Website",{github:h})}
...
</div>`}function n(){return e`<div>
${t("Making it efficient",{})}
...
</p>`}function a(){return e`<div>
${t("Making it configurable",{})}
...
</div>`}function s(){return e`<div>
${t("So many emojis \u{1F635}\u200D\u{1F4AB}",{})}
