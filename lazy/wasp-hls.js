var e="https://peaberberian.github.io/wasp-hls/",n="https://peaberberian.github.io/wasp-hls/doc/Getting_Started/Welcome.html",t="https://github.com/peaBerberian/wasp-hls";function h(s,o){let{strHtml:a,createAppTitle:i,createAppIframe:r}=o.appUtils;return{sidebar:[{text:"Overview",icon:"\u{1F9D1}\u200D\u{1F3EB}",centered:!0,render:()=>a`<div>
${i("WASP-HLS",{github:t,doc:n,demo:e})}

<p><a href="${t}" target="_blank">WASP-HLS</a> is a personal project where I did some R&D on the side to see how a very efficient web media player could look like:
<ul>
...
</div>`},{text:"Demo",icon:"\u{1F4FA}",noPadding:!0,render:()=>r(e)}]}}export{h as create};
