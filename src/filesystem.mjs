 ...
 *
 * - `systems/constants.json`: This corresponds to the `./constants.mjs`
 *   exported values.
 *
 * ### `/userdata/`
 *
...
class DesktopFileSystem {
  ...
  async readFile(path, format) {
    ...
    if (path.startsWith(SYSTEM_DIR)) {
      ...
      try {
        if (wantedFile === "constants.json") {
          return parseToWantedFormat(CONSTANTS, format);
        }
